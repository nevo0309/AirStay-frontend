      ...
      <section>
        <footer className="footer flex column">
          ...
          <p className='linkdin flex'>
            <a href="https://www.linkedin.com/in/ofir-bozna-704857306?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" target="_blank" rel="noreferrer">
              <i className="fa-brands fa-linkedin"></i> Ofir Bozna Nidam
            </a>
            |
            <a href="https://www.linkedin.com/in/nevo-yaakoby-1a9453245?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app" target="_blank" rel="noreferrer">
          ...
          <p className='github flex column'>
            <div className="flex">
              ...
              |
              <a href="https://github.com/nevo0309/airstay-backend" target="_blank" rel="noreferrer">
