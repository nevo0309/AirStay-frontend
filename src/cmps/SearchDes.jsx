...
export function SearchDes({ setLocation, setOpenModal }) {
    ...
    return <section className="suggested-des-container" >
        <section className="suggested-des">
            <h1>Suggested destinations</h1>
            <div className="des-card flex" onClick={() => onSetLocation('Nearby')}>
                <img src="https://a0.muscache.com/im/pictures/airbnb-platform-assets/AirbnbPlatformAssets-hawaii-autosuggest-destination-icons-2/original/ea5e5ee3-e9d8-48a1-b7e9-1003bf6fe850.png" alt="location" />
                <div>
                    <h1>Nearby</h1>
            ...
            <div className="des-card flex" onClick={() => onSetLocation('Rome')}>
                ...
                <div>
                    <h1>Rome, Italy</h1>
                    <p>For sights like Trevi Fountain</p>
                </div>
            </div>
            ...
            <div className="des-card flex" onClick={() => onSetLocation('London')}>
                ...
                <div>
                    ...
                    <p>For its busting night life</p>
                </div>
            </div>
            ...
            <div className="des-card flex" onClick={() => onSetLocation('Atens')}>
                ...
                <div>
                    <h1>Atens, Greece</h1>
                    <p>For sights like Acropolis of Athens</p>
                </div>
            </div>
            ...
            <div className="des-card flex" onClick={() => onSetLocation('Tbilisi')}>
                ...
                <div>
                    ...
                    <p>For sights like Bridge of Peace</p>
                </div>
            </div>
